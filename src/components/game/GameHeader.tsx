  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-2">
        ...
        <div className="text-sm text-gray-500 mb-2">Register your interest by reacting to the WhatsApp message with a thumbs up 👍</div>
        <div className="text-sm text-gray-500 mb-2">DM me with any names of reserves outside of the WhatsApp group that want to play!</div>
