-- Fix merge_players function to include player_awards table handling
-- This prevents trophies from being lost when players are merged
...
BEGIN
    ...
    -- =====================================================
    -- NEW: Handle player_awards (trophies)
    -- =====================================================
...
- Notifications
- Penalties
- Player awards/trophies (added Jan 2026)
