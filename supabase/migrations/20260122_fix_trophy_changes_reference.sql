-- =====================================================
-- Fix: Remove broken trophy_changes references
-- =====================================================
-- The migration 20260117_fix_consecutive_losses_bug.sql introduced
-- references to a 'trophy_changes' table/view that doesn't exist.
-- This migration fixes the function by removing those broken queries.
-- =====================================================
...
BEGIN
  ...
  -- NOTE: Trophy insights removed - trophy_changes table doesn't exist
  -- Trophy insights should be generated via awards system if needed
...
'Generates post-match insights for a game. Fixed in 20260122 to remove references
to non-existent trophy_changes table.';
